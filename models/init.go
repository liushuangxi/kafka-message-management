...
// KafkaTopicCollectTBName
func KafkaTopicCollectTBName() string {
	return TableName("kafka_topic_collect")
}

// KafkaBrokerTBName
func KafkaBrokerTBName() string {
	return TableName("kafka_broker")
}
